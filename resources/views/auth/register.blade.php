            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row">
                            <hr class="hrline crearfix" width="90%">
                            <h2 class="mx-auto" style="padding: 20px;">お名前</h2> 
                        </div>

                        <div class="form-group row">
                            <label for="last_name" class="col-md-4 col-form-label text-md-right mb-100">{{ __('last_name') }}</label>
                        ...
                        <div class="row">
                            <hr class="hrline crearfix" width="90%">
                            <h2 class="mx-auto" style="padding: 20px;">住所</h2> 
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="municipality" class="col-md-4 col-form-label text-md-right">{{ __('municipality') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="apartments" class="col-md-4 col-form-label text-md-right">{{ __('apartments') }}</label>

                            <div class="col-md-6">
                                <input id="apartments" type="text" name="apartments" value="{{ old('apartments') }}" autocomplete="apartments" autofocus>
                            </div>
                        </div>

                        <div class="row">
                            <hr class="hrline crearfix" width="90%">
                            <h2 class="mx-auto" style="padding: 20px;">ご連絡先</h2> 
                        </div>
